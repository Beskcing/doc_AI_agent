...
- 工具链：`src/tools/` (mineru_parser, pandoc_converter, docx_styler, markdown_cleaner, html_table_preserver, content_normalizer, content_pattern_matcher, docx_normalizer)
